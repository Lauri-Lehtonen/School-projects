...
#                                                                  #
# edits made to ready code: added few public methods to header     #
# to make accessing private members containing game element        #
# points possible.                                                 #
# methods added: getfood(), head_to_gui(). tail to gui() and       #
# checkSnakePoint                                                  #
#                                                                  #
# Author: Lauri lehtonen, 050023118, lauri.e.lehtonen@tuni.fi      #
####################################################################
*/
...
public:
    ...
    //  used to access private members of this class from the GUI
    //  to draw them onto the game board.
    Point getfood()
    {
        return food_;
    }
    ...
    bool checkSnakePoint(Point p)
    {
        return isSnakePoint(p);
    }
